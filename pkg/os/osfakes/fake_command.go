...
func (fake *FakeCommand) Process() os.Process {
...
func (fake *FakeCommand) ProcessCalls(stub func() os.Process) {
	fake.processMutex.Lock()
	defer fake.processMutex.Unlock()
	fake.ProcessStub = stub
}

func (fake *FakeCommand) ProcessReturns(result1 os.Process) {
	fake.processMutex.Lock()
	defer fake.processMutex.Unlock()
...
func (fake *FakeCommand) ProcessReturnsOnCall(i int, result1 os.Process) {
	fake.processMutex.Lock()
	defer fake.processMutex.Unlock()
	fake.ProcessStub = nil
...
var _ os.Command = new(FakeCommand)
