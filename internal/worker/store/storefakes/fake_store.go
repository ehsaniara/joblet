...
type FakeStore struct {
	...
	SendUpdatesToClientStub        func(context.Context, string, store.DomainStreamer) error
	sendUpdatesToClientMutex       sync.RWMutex
	sendUpdatesToClientArgsForCall []struct {
		arg1 context.Context
		arg2 string
		arg3 store.DomainStreamer
	}
...
func (fake *FakeStore) SendUpdatesToClient(arg1 context.Context, arg2 string, arg3 store.DomainStreamer) error {
...
func (fake *FakeStore) SendUpdatesToClientCalls(stub func(context.Context, string, store.DomainStreamer) error) {
	fake.sendUpdatesToClientMutex.Lock()
	defer fake.sendUpdatesToClientMutex.Unlock()
	fake.SendUpdatesToClientStub = stub
}

func (fake *FakeStore) SendUpdatesToClientArgsForCall(i int) (context.Context, string, store.DomainStreamer) {
	fake.sendUpdatesToClientMutex.RLock()
	defer fake.sendUpdatesToClientMutex.RUnlock()
