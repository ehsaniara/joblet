...
func (w *linuxJoblet) StartJob(ctx context.Context, command string, args []string, maxCPU, maxMemory, maxIOBPS int32) (*domain.Job, error) {
	return w.platformJoblet.StartJob(ctx, command, args, maxCPU, maxMemory, maxIOBPS)
}
